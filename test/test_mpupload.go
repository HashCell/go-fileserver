...
func main() {
	username := "admin12"
	token := "39d08e63fdcda062a0f6288bfbe9dd235ead1abd"
	filehash := "3d7e8b5d37cf2bc882ae6dad910f2b565c7683b7"
	...
	// 3. 请求分块上传接口
	filename := "/home/steve/Downloads/go1.14.1.linux-amd64.tar.gz"
	tURL := "http://localhost:8080/file/mpupload/split?" +
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"123631885"},
			"filename": {"go1.14.1.linux-amd64.tar.gz"},
			"uploadid": {uploadID},
		})
